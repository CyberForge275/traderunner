...
class InsideBarConfig:
    ...
    max_breakout_range_bars: Optional[int] = None
    breakout_confirmation_mode: str = "touch"  # touch|close (legacy default keeps behavior)
    ...
    def validate(self) -> None:
        ...
        assert self.breakout_confirmation_mode in ["touch", "close"], \
            f"Invalid breakout_confirmation_mode: {self.breakout_confirmation_mode}"
        ...
        if self.max_breakout_range_bars is not None:
            bars = int(self.max_breakout_range_bars)
            assert 1 <= bars <= 4, "max_breakout_range_bars must be in [1,4] or null"
...
def build_inside_bar_config(params: dict) -> InsideBarConfig:
    """Single SSOT mapper: dict -> InsideBarConfig with fail-fast semantics."""
    ...
    core_params = {
        ...
        "breakout_confirmation_mode": params.get("breakout_confirmation_mode", "touch"),
        ...
        "max_breakout_range_bars": params.get("max_breakout_range_bars"),

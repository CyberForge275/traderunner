...
def _schema_v1_0_0() -> SignalFrameSchemaV1:
    ...
    strategy_cols: List[ColumnSpec] = [
        ...
        ColumnSpec("adx_14", "float64", True, "indicator"),
        ColumnSpec("dbg_adx_14", "float64", True, "indicator"),
        ColumnSpec("adx_7", "float64", True, "indicator"),
        ColumnSpec("dbg_adx_7", "float64", True, "indicator"),
        ColumnSpec("rvol_20", "float64", True, "indicator"),
        ColumnSpec("ema_7", "float64", True, "indicator"),
        ColumnSpec("ema_15", "float64", True, "indicator"),

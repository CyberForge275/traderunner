...
# Add src to path for testing - must be done before other imports
...
class TestStrategyRegistry:
    ...
    def test_unregister_strategy(self):
        ...
        assert self.registry.unregister("test_strategy") is True
...
class TestStrategyFactory:
    ...
    def test_validate_strategy_config(self):
        ...
        with patch("strategies.factory.registry", self.registry):
            ...
            # Invalid config
            assert (
                StrategyFactory.validate_strategy_config("mock_strategy", {}) is False
            )
